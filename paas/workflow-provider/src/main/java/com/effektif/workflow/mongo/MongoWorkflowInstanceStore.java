...
import com.effektif.workflow.mongo.WorkflowInstanceFields.Lock;
...
import static com.effektif.workflow.mongo.ActivityInstanceFields.ACTIVITY_ID;
import static com.effektif.workflow.mongo.ActivityInstanceFields.CALLED_WORKFLOW_INSTANCE_ID;
import static com.effektif.workflow.mongo.ActivityInstanceFields.DURATION;
import static com.effektif.workflow.mongo.ActivityInstanceFields.END;
import static com.effektif.workflow.mongo.ActivityInstanceFields.END_STATE;
import static com.effektif.workflow.mongo.ActivityInstanceFields.ID;
import static com.effektif.workflow.mongo.ActivityInstanceFields.PARENT;
import static com.effektif.workflow.mongo.ActivityInstanceFields.START;
import static com.effektif.workflow.mongo.ActivityInstanceFields.WORK_STATE;
import static com.effektif.workflow.mongo.MongoDb._ID;
import static com.effektif.workflow.mongo.MongoHelper.readId;
import static com.effektif.workflow.mongo.MongoHelper.readList;
import static com.effektif.workflow.mongo.MongoHelper.readLong;
import static com.effektif.workflow.mongo.MongoHelper.readObject;
import static com.effektif.workflow.mongo.MongoHelper.readObjectMap;
import static com.effektif.workflow.mongo.MongoHelper.readString;
import static com.effektif.workflow.mongo.MongoHelper.readTime;
import static com.effektif.workflow.mongo.MongoHelper.readWorkflowInstanceId;
import static com.effektif.workflow.mongo.MongoHelper.writeListElementOpt;
import static com.effektif.workflow.mongo.MongoHelper.writeLongOpt;
import static com.effektif.workflow.mongo.MongoHelper.writeObjectOpt;
import static com.effektif.workflow.mongo.MongoHelper.writeString;
import static com.effektif.workflow.mongo.MongoHelper.writeTimeOpt;
import static com.effektif.workflow.mongo.WorkflowInstanceFields.ACTIVITY_INSTANCES;
import static com.effektif.workflow.mongo.WorkflowInstanceFields.ARCHIVED_ACTIVITY_INSTANCES;
import static com.effektif.workflow.mongo.WorkflowInstanceFields.BUSINESS_KEY;
import static com.effektif.workflow.mongo.WorkflowInstanceFields.CALLING_ACTIVITY_INSTANCE_ID;
import static com.effektif.workflow.mongo.WorkflowInstanceFields.CALLING_WORKFLOW_INSTANCE_ID;
import static com.effektif.workflow.mongo.WorkflowInstanceFields.JOBS;
import static com.effektif.workflow.mongo.WorkflowInstanceFields.LOCK;
import static com.effektif.workflow.mongo.WorkflowInstanceFields.NEXT_ACTIVITY_INSTANCE_ID;
import static com.effektif.workflow.mongo.WorkflowInstanceFields.NEXT_VARIABLE_INSTANCE_ID;
import static com.effektif.workflow.mongo.WorkflowInstanceFields.ORGANIZATION_ID;
import static com.effektif.workflow.mongo.WorkflowInstanceFields.PROPERTIES;
import static com.effektif.workflow.mongo.WorkflowInstanceFields.VARIABLE_INSTANCES;
import static com.effektif.workflow.mongo.WorkflowInstanceFields.WORK;
import static com.effektif.workflow.mongo.WorkflowInstanceFields.WORKFLOW_ID;
import static com.effektif.workflow.mongo.WorkflowInstanceFields.WORK_ASYNC;
  ...
  private void readVariableInstances(ScopeInstanceImpl parent, BasicDBObject dbWorkflowInstance) {
    ...
    if (dbVariableInstances!=null && !dbVariableInstances.isEmpty()) {
      for (BasicDBObject dbVariableInstance: dbVariableInstances) {
        com.effektif.workflow.api.workflowinstance.VariableInstance variableInstance = mongoMapper.read(dbVariableInstance, WorkflowInstanceFields.VariableInstance.class);
  ...
  protected void writeVariableInstances(BasicDBObject dbScope, ScopeInstanceImpl scope) {
    if (scope.variableInstances!=null) {
      for (VariableInstanceImpl variableInstanceImpl: scope.variableInstances) {
        com.effektif.workflow.api.workflowinstance.VariableInstance variableInstance = variableInstanceImpl.toVariableInstance();
